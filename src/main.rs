...
mod tests {
    ...
    fn test_remove_port_if_present_edge_cases() {
        ...
        assert_eq!(remove_port_if_present("[]:8080"), Some(String::new())); // Bracket logic extracts empty string
    ...
    fn test_ip_finder_src_dst() {
        ...
        assert_eq!(
            ip_finder(&format!("src:{EXAMPLE_V6_1}, dst:{EXAMPLE_V6_2}")),
    ...
    fn test_ip_finder_ipv6_with_ports() {
        assert_eq!(
            ip_finder(&format!("{EXAMPLE_V6_1}:65000")),
            vec![EXAMPLE_V6_1]
        );
        let input = format!("{EXAMPLE_V6_1}:65000, {EXAMPLE_V6_2}:80");
        ...
        assert_eq!(
            ip_finder(&format!("[{EXAMPLE_V6_1}]:65000, [{EXAMPLE_V6_2}]:80")),
            vec![EXAMPLE_V6_1, EXAMPLE_V6_2]
        );
    }
